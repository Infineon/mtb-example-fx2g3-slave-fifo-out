 ...
 * \brief Datawire ISR for slaveFIFO TX channels
 * \retval None
 */
void Cy_Slff_TxChannelDataWire_ISR (void)
{
    /*
     * DataWire-0 channels are used to receive data from the USB host to the FX2G3 through IN endpoints.
     * Call the general handler for DataWire-0 interrupts which is a part of the HbDma library.
     */

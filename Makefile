...
APPNAME=mtb-example-fx2g3-slave-fifo-out
...
# NOTE: This default setting is intended for internal use only and does not impact user builds, even if the sales product target is modified.
